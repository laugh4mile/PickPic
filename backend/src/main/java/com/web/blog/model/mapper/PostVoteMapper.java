...
public interface PostVoteMapper {
	// 투표했는지 여부
	public int checkVoted(Map<String, Object> map) throws SQLException;
	// 투표했는지 여부
	public PostVoteDto getVoteInfo(Map<String, Object> map) throws SQLException;
	// 투표한적 없다면 투표한다
	...
	// 해당 사진 투표 수
	public int getVoteCount(String picNo) throws SQLException;
